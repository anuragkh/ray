...
set(arrow_TAG evict_to_external_store)
...
string (REPLACE ";" "|" AWSSDK_LINK_LIBS "${AWSSDK_LINK_LIBRARIES}")

set(ARROW_CMAKE_ARGS
  -DCMAKE_BUILD_TYPE:STRING=Release
  -DCMAKE_INSTALL_PREFIX=${ARROW_INSTALL_PREFIX}
  -DCMAKE_C_FLAGS=-g -O3 ${EP_C_FLAGS}
  -DCMAKE_CXX_FLAGS=-g -O3 ${EP_CXX_FLAGS} -isystem ${CMAKE_SOURCE_DIR}/external/arrow/cpp/src/plasma
  ...
  -DPLASMA_EXTRA_EXTERNAL_STORE_SOURCES=${CMAKE_SOURCE_DIR}/external/arrow/cpp/src/plasma/s3_store.cc
  -DPLASMA_EXTERNAL_STORE_LIBDIRS=${AWSSDK_LIB_DIR}
  -DPLASMA_EXTERNAL_STORE_LIBS=${AWSSDK_LINK_LIBS}
